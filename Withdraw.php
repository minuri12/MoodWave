        ...
        <div class="registerform" >
              <div class="row2">
                  <div class="title">
                   ...
                   <div class="input-container-row" >
                    <div class="input-container_register" >
                      ...
                      <input  class="input_text" placeholder="Michel" type="text" name="name_on_card"  required  id="text1"/>
                  </div>
                  <div class="input-container_register" >
                    <label for="" >Amount(LKR)</label><br>
                    <input  id="amountInput" class="input_text" placeholder="5000" name="amount" type="number" required   />
                </div>
                   </div>
                  ...
                  <div class="input-container_register">
                       ...
                       <input type="text" name="card_details" class="input_text" placeholder="0000-0000-0000-0000" maxlength="16"  />
                   </div>
                     <div class="input-container-row" style="display: flex;">
                      <div class="input-container_register" >
                        <label for="" >Exp. Date</label><br>
                        <input type="date"  class="input_text" placeholder="10/25" name="expiary" type="text" maxlength="5" required id="text1"/>
                    </div>
                    <div class="input-container_register" >
